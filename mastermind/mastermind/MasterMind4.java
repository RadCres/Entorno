...
public class MasterMind4 {
	private ColorCombinacion[] enigma;
	/**
	 * Sortea el enigma a adivinar
	 * @return vector de 4 posiciones con números entre 1 y 5 
	 */
	 ...
	 */
	public ColorCombinacion[] pedirCombinacion() {
		return null;
		//TODO
	}
	 ...
	 * @param resultado
	 */
	void comprobarPosicion(ColorCombinacion[] combinacion, ColorResultado[] resultado) {		
		//TODO
	}
	 ...
	 */
	ColorResultado[] comprobarColor( ColorCombinacion[] combinacion) {
		//TODO
		return null;
	}
	 ...
	 */
	public int[] comprobarCombinacion( ColorCombinacion[] combinacion) {
		//TODO
		return null;
	}
